...
class CallManager {
  ...
  void _initCalls() {
    ...
    _callClient!.onReceiveNewSession = (callSession) async {
      ...
      } else if (callState == CallState.UNKNOWN || callState == CallState.PENDING) {
...
// ✅ SHOW the system call UI
        CallEvent callEvent = CallEvent(
          ...
          callerName: 'Caller Name', // You can fetch real name if available
          opponentsIds: _currentCall!.opponentsIds,
          callPhoto: 'https://i.imgur.com/KwrDil8b.jpg', // Replace as needed
  ...
  void startNewCall(BuildContext context, int callType, Set<int> opponents) async {
  ...
  Future<String> _getCallState(String sessionId) async {
    if (Platform.isAndroid || Platform.isIOS) {
      var callState = ConnectycubeFlutterCallKit.getCallState(sessionId: sessionId);
      return callState;
    }
